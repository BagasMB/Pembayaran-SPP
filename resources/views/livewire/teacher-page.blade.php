<div>
    ...
    <div class="card card-responsive mb-3">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Data Teachers</h5>
            <a href="{{ route('teacher.create') }}" class="badge bg-label-primary" type="button">
                        ...
                        @foreach ($teacherList as $list)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('teacher.edit', $list->id) }}" type="button"
                                        class="btn btn-warning btn-sm">
                                        <i class="bx bx-edit"></i>
                                    </a>
                                    {{-- <a id="btn-hapus" href="delete-student/{{ $list->id }}"
